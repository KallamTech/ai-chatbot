...
export const ToolInput = ({ className, input, ...props }: ToolInputProps) => (
  <div
    className={cn('space-y-2 overflow-hidden p-4 max-w-full', className)}
    {...props}
  >
    <h4 className="font-medium text-muted-foreground text-xs uppercase tracking-wide">
      Parameters
    </h4>
    <div className="rounded-md bg-muted/50 max-w-full overflow-x-auto">
...
export const ToolOutput = ({
  ...
  return (
    <div className={cn('space-y-2 p-4 max-w-full', className)} {...props}>
      ...
      <div
        className={cn(
          'overflow-x-auto rounded-md text-xs [&_table]:w-full max-w-full break-words',
          errorText
      ...
      >
        ...
        {output && <div className="break-words">{output}</div>}
      </div>
    </div>
  );
};
