...
export enum ModelId {
  ...
  GEMINI_3_PRO_REASONING = 'google/gemini-3-pro-preview',
  ...
  MISTRAL_LARGE = 'mistral/mistral-large-3',
  ...
  isTestEnvironment && testModels
    ? customProvider({
        languageModels: {
          ...
          [ModelId.CLAUDE_HAIKU_4_5]: testModels.chatModel,
          [ModelId.CLAUDE_OPUS_4_5]: testModels.reasoningModel,
          [ModelId.CLAUDE_SONNET_4_5]: testModels.reasoningModel,
          [ModelId.GEMINI_3_PRO_REASONING]: testModels.reasoningModel,
          [ModelId.GEMINI_3_PRO_IMAGE]: testModels.chatModel,
          ...
          [ModelId.KIMI_K2_THINKING]: testModels.reasoningModel,
    ...
    : customProvider({
        languageModels: {
          ...
          [ModelId.CLAUDE_HAIKU_4_5]: gateway.languageModel(
          ...
          [ModelId.KIMI_K2_THINKING]: wrapLanguageModel({
            model: gateway.languageModel(ModelId.KIMI_K2_THINKING),
          ...
          [ModelId.GPT_5_CODEX]: wrapLanguageModel({
            model: gateway.languageModel(ModelId.GPT_5_CODEX),
            middleware: [
              defaultSettingsMiddleware({
                settings: {
                  providerOptions: {
          ...
          [ModelId.CLAUDE_OPUS_4_5]: wrapLanguageModel({
            model: gateway.languageModel(ModelId.CLAUDE_OPUS_4_5),
            middleware: [
              defaultSettingsMiddleware({
                settings: {
                  providerOptions: {
          ...
          [ModelId.CLAUDE_SONNET_4_5]: wrapLanguageModel({
          ...
          [ModelId.GEMINI_3_PRO_REASONING]: wrapLanguageModel({
          ...
          [ModelId.GEMINI_3_PRO_IMAGE]: gateway.languageModel(
