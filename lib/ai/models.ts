...
export const chatModels: Array<ChatModel> = [
  ...
  },
  {
    ...
    name: 'GPT-5 Codex',
    description: 'GPT-5 with advanced reasoning capabilities for coding tasks',
    provider: 'OpenAI',
    hasReasoning: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Anthropic highly capable lightweight model',
    provider: 'Anthropic',
  },
  {
  ...
  {
    id: ModelId.GEMINI_3_PRO_REASONING,
    name: 'Gemini 3 Pro Reasoning',
    description: 'Gemini 3 Pro with advanced reasoning capabilities',
    provider: 'Google',
    hasReasoning: true,
  },
  {
